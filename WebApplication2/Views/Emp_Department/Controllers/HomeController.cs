        ...
        public ActionResult Save()
        {
            ...
            else
            {
                ...
                if (count != 0)
                {
                    ...
                    if (Session["SubBatchFilling"].ToString() != "0" || Session["SubBatchFillingAdd"].ToString() != "0" || Session["SubBatchFillingView"].ToString() != "0" || Session["SubBatchFillingUpdate"].ToString() != "0")
                        Session["SubBatchFilling"] = 2;
                    else
                        Session["SubBatchFilling"] = GetFormStatus(Session["UserID"].ToString(), 6002, 2);
