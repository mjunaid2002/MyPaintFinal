    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Save(HttpPostedFileBase file, Employee Employee)
        {
            ...
            if (file != null)
            {
                ...
                _context.Database.ExecuteSqlCommand("insert into Employees values(" + Employee.ID + ",N'" + Employee.Name + "','" + Employee.Email + "',N'" + Employee.Address + "','" + img + "','" + Employee.Phone + "',"+ account_no1 + ",0," + Employee.mon_sal + "," + Employee.dal_sal + ",'" + Employee.joiningdate + "'," + Employee.dai_insentive + "," + Employee.cnic + "," + Employee.mon_insentive + ")");
            ...
            {
                _context.Database.ExecuteSqlCommand("insert into Employees values(" + Employee.ID + ",N'" + Employee.Name + "','" + Employee.Email + "',N'" + Employee.Address + "','0','" + Employee.Phone + "'," + account_no1 + ",0," + Employee.mon_sal + "," + Employee.dal_sal + ",'" + Employee.joiningdate + "'," + Employee.dai_insentive + "," + Employee.cnic + "," + Employee.mon_insentive + ")");
