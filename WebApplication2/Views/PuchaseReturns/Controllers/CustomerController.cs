...
namespace WebApplication1.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult Save(Customers customers)
        {
            ...
            _context.Database.ExecuteSqlCommand("insert into customers (customerid,Name,address,Cityid,sectorid,Phone,mobile,email,discount,accno,partywht) values(" + customers.customerid + ",N'" + customers.Name + "',N'" + customers.Address + "',1,1,N'" + customers.Phone + "',N'" + customers.mobile + "',N'" + customers.email + "',0," + account_no1 + ",1)");
