...
namespace WebApplication1.Controllers
{
    ...
    public class BatchReturnController : Controller
    {
        ...
        {
            var allow_list = _context.Database.SqlQuery<Products>("select batch as BatchNo,weight as totalweight from tbl_BatchTransfer where status='Transfer' and color='" + value + "' ORDER BY Id  DESC").ToList();
