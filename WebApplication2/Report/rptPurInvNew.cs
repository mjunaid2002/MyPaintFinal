...
namespace WebApplication2.Report {
    ...
    public class rptPurInvNew : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebApplication2.Report.rptPurInvNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptPurInvNew : Component, ICachedReport {
        
        public CachedrptPurInvNew() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptPurInvNew rpt = new rptPurInvNew();
            rpt.Site = this.Site;
            return rpt;
        }
