...
namespace WebApplication2.Report {
    ...
    public class rptPONew : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebApplication2.Report.rptPONew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptPONew : Component, ICachedReport {
        
        public CachedrptPONew() {
        }
